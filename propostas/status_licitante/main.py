...
from propostas.status_licitante.scraper_status import obter_status_anexos

rabbit_config = RabbitConfig(fila_entrada='pregao-status-licitante')
consumer = Consumer(Config(rabbit=rabbit_config))
codigo_operacao='status_licitante'
...
def callback(message: str) ->  Result[bool, Exception]:
    ...
    try:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            obter_status_anexos(dados_pregao,main_driver)
